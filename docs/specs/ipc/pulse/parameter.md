...
[Parameters Architecture](../../architecture/B03-parameters.md) and
...
Cohort semantics are defined in the [Processing Cohorts](../architecture/A06-processing-cohorts-and-anticipative-rendering.md) architecture document.
