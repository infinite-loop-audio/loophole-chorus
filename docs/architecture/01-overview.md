...
For complete details, see [@chorus:/docs/architecture/06-processing-cohorts-and-anticipative-rendering.md](06-processing-cohorts-and-anticipative-rendering.md).
