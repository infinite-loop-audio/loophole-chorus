...
### 2.1 TypeScript/Node, in-process (embedded in Aura)
...
### 2.2 TypeScript/Node, separate Pulse server
...
1. Create `@chorus:/docs/architecture/XX-pulse-implementation-plan-rust.md`:
